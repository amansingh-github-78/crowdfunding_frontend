        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a
                href="#"
                className="text-blue-700 hover:text-blue-900 dark:hover:text-white"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
              ...
              <a
                href="#"
                className="text-blue-700 hover:text-blue-900 dark:hover:text-white ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
              ...
              <a
                href="https://github.com/amansingh-github-78/crowdfunding_frontend.git" 
                target="_blank"
                className="text-blue-700 hover:text-blue-900 dark:hover:text-white ms-5"
              >
                <svg
