    ...
    <>
      <nav className="bg-blue-50 border-gray-200 dark:bg-blue-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <img src="/fmk_logo.png" className="h-8" alt="Flowbite Logo" />
          ...
          >
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border-2 border-blue-400 rounded-lg bg-blue-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-blue-50 dark:bg-blue-900 md:dark:bg-blue-900 dark:border-blue-800">
              ...
              <li className="md:block lg:hidden hidden ">
                <button
                  type="button"
                  className="block py-2 px-3 text-blue-900 rounded-sm hover:bg-blue-600 md:hover:bg-transparent md:hover:text-indigo-600 md:p-0 dark:text-white md:dark:hover:text-indigo-300 cursor-pointer "
                  id="campaign-menu-button"
                  aria-expanded="false"
                  data-dropdown-toggle="campaign-dropdown"
                ...
                <div
                  className="z-50 hidden text-base list-none"
                  id="campaign-dropdown"
                >
                  <ul
                    className="my-4 ml-8 flex flex-row font-medium p-4 md:p-0 border border-blue-100 rounded-lg bg-blue-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-blue-50 dark:bg-blue-900 md:dark:bg-blue-900 dark:border-blue-800"
